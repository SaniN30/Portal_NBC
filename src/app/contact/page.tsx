...
export default function ContactPage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <h1 data-reveal-css className="mt-6 font-display text-4xl font-semibold tracking-tight sm:text-5xl">Get in touch</h1>
      <p data-reveal-css className="mt-3 max-w-prose text-[var(--muted)]">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <a
          href={`mailto:${EMAIL}`}
          data-reveal-css
          className="card group flex flex-col p-6 transition hover:-translate-y-1 hover:border-[color-mix(in_oklab,var(--brand)_45%,var(--border))]"
        >
        ...
        <div data-reveal-css className="card flex flex-col p-6">
